<?
    $init_processing = function(Module $module) {
        ...
        $GLOBALS['doc_extensions_body_bottom_elements'] = [];
    ...
    function doc_extensions_add_body_bottom_element(string $line): void {
        $GLOBALS['doc_extensions_body_bottom_elements'][] = $line;
    }
    ...
    function body_bottom_element_start(): void {
        ob_start();
    }

    function body_bottom_element_end(): void {
        doc_extensions_add_body_bottom_element(ob_get_clean());
    }
    ...
    function doc_extensions_get_body_bottom_elements(): array {
        return $GLOBALS['doc_extensions_body_bottom_elements'];
    }
