...
Conjin-authored code is licensed under [GPL-3.0-or-later](./COPYING). Dependencies and redistributed assets retain their own licenses; see [THIRD_PARTY_NOTICES.md](./THIRD_PARTY_NOTICES.md).
