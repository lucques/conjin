...
This module extends Bootstrap with additional features such as stacks, slices, and further colors, and provides PHP macros for Bootstrap components. The extensions are independent of page layout and provide styles for standalone markup without requiring a surrounding context.

## Features

- Extends Bootstrap with stacks, slices, further colors, and related styles.
- Provides PHP macros for Bootstrap components.

## Usage

The module can be used in two ways:

1. As a minimalistic module out of the box.
...
## Grid and flex layout: `d-grid`, `d-flex`
