<?
    ...
    // $level: 1 means "the target's title"
    function anchor_create(int $level, string $id): array {
    ...
    function anchor_create_from_title(int $level, string $title): array {
        return anchor_create($level, kebabize($title));
    }

    function get_current_anchor_ids(): array {
        return $GLOBALS['anchors_current_ids'];
    }
?>
