...
----------------------------------------------
-- Deployment: Isolated integration testing --
----------------------------------------------
...
let TestDepl = {
    , depl                   : DockerDepl
    , playwrightTestsDir     : Optional Text
    , db                     : Optional TestDb
    , store                  : Optional TestStore
    , preprocessUser         : Text
    , linkchecker             : Linkchecker
}
...
let RClone = {
    , name                 : Text
    , dir                  : Text
    , configPath           : Text -- Path to the rclone.conf file, not its parent directory
}
...
let RemoteDepl = {
    ...
    , host                : Text
    , pathBase            : Text   -- e.g. `/htdocs/my-app-dir` base/root directory in the filesystem
...
{ SharedModuleLocation, SharedBareModule, sharedBareModuleToLocation, sharedBareModuleToScssDeps,
  ...
  Authentication, AuthenticationWithoutPasswords, Authorization, LocalDb, TestDb, RemoteDb, LocalStore, TestStore, RemoteStore, RClone, DockerDepl, Mail, DesktopIntegration, Linkchecker,
  LocalErrors, RemoteErrors,
  HTTPS, WWWSubdomain,
  RemoteErrorLogging,
  LocalDepl, TestDepl, RemoteDepl,
  OpenIdProvider,
