...
let AuthenticationWithoutPasswordsT = {
    , staticLoginWithoutUserName: Bool
    , usersXgroups: List UserXGroupT
    , openIdProviders: List OpenIdProvider
}
...
let tagAuthenticationWithoutPasswords = \(a: AuthenticationWithoutPasswords) ->
    a // {
        , usersXgroups = P.List.map UserXGroup UserXGroupT tagUserXGroup a.usersXgroups
    }: AuthenticationWithoutPasswordsT
...

{
    ...
    , tagAuthenticationWithoutPasswords
    , tagAuthorization
    , tagLocalDepl
    , tagTestDepl
    , tagRemoteDepl
